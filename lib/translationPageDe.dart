...
class TranslatePageDe extends StatefulWidget {
  const TranslatePageDe({super.key});

  @override
  State<TranslatePageDe> createState() => _TranslatePageDe();
}

class _TranslatePageDe extends State<TranslatePageDe> {
  ...
  void translate() {
    ...
    // Use the translator library to translate the input text to Danish ("da").
    translator.translate(inputText, to: "da").then((output) {
      setState(() {
